		...
		pgs_block_t* _source_block)
{
	...
	_encoded_block->chunk[4].bit =
		_source_block->chunk[1].bit ^
		_source_block->chunk[2].bit ^
		_source_block->chunk[3].bit;
	_encoded_block->chunk[5].bit =
		_source_block->chunk[0].bit ^
		_source_block->chunk[2].bit ^
		_source_block->chunk[3].bit;
	_encoded_block->chunk[6].bit =
		_source_block->chunk[0].bit ^
		_source_block->chunk[1].bit ^
		_source_block->chunk[3].bit;
}
		...
		pgs_block_t* _encoded_block)
{
	...
	if (unlikely(syndrome_hamming74 == NULL))
		pgp_null();
	syndrome_hamming74->chunk[0].bit =
		_encoded_block->chunk[3].bit ^
		_encoded_block->chunk[4].bit ^
		_encoded_block->chunk[5].bit ^
		_encoded_block->chunk[6].bit;
	syndrome_hamming74->chunk[1].bit =
		_encoded_block->chunk[1].bit ^
		_encoded_block->chunk[2].bit ^
		_encoded_block->chunk[5].bit ^
		_encoded_block->chunk[6].bit;
	syndrome_hamming74->chunk[2].bit =
		_encoded_block->chunk[0].bit ^
		_encoded_block->chunk[2].bit ^
		_encoded_block->chunk[4].bit ^
		_encoded_block->chunk[6].bit;
